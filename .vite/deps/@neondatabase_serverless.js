...
trict";
	...
	mi = Se(ge(), 1);
	a(ha, "isIP");
	yi = /^[^.]+\./, S = class S$1 extends mi.EventEmitter {
		constructor() {
			super(...arguments);
			E(this, "opts", {});
			E(this, "connecting", !1);
		...
		static get poolQueryViaFetch() {
			return S$1.opts.poolQueryViaFetch ?? S$1.defaults.poolQueryViaFetch;
		}
		static set poolQueryViaFetch(t) {
			S$1.opts.poolQueryViaFetch = t;
		}
		static get fetchEndpoint() {
			return S$1.opts.fetchEndpoint ?? S$1.defaults.fetchEndpoint;
		}
		static set fetchEndpoint(t) {
			S$1.opts.fetchEndpoint = t;
		}
		...
		static get fetchFunction() {
			return S$1.opts.fetchFunction ?? S$1.defaults.fetchFunction;
		}
		static set fetchFunction(t) {
			S$1.opts.fetchFunction = t;
		}
		static get webSocketConstructor() {
			return S$1.opts.webSocketConstructor ?? S$1.defaults.webSocketConstructor;
		}
		static set webSocketConstructor(t) {
			S$1.opts.webSocketConstructor = t;
		}
		get webSocketConstructor() {
			return this.opts.webSocketConstructor ?? S$1.webSocketConstructor;
		}
		set webSocketConstructor(t) {
			this.opts.webSocketConstructor = t;
		}
		static get wsProxy() {
			return S$1.opts.wsProxy ?? S$1.defaults.wsProxy;
		}
		static set wsProxy(t) {
			S$1.opts.wsProxy = t;
		}
		get wsProxy() {
			return this.opts.wsProxy ?? S$1.wsProxy;
		}
		set wsProxy(t) {
			this.opts.wsProxy = t;
		}
		static get coalesceWrites() {
			return S$1.opts.coalesceWrites ?? S$1.defaults.coalesceWrites;
		}
		static set coalesceWrites(t) {
			S$1.opts.coalesceWrites = t;
		}
		get coalesceWrites() {
			return this.opts.coalesceWrites ?? S$1.coalesceWrites;
		}
		set coalesceWrites(t) {
			this.opts.coalesceWrites = t;
		}
		static get useSecureWebSocket() {
			return S$1.opts.useSecureWebSocket ?? S$1.defaults.useSecureWebSocket;
		}
		static set useSecureWebSocket(t) {
			S$1.opts.useSecureWebSocket = t;
		}
		get useSecureWebSocket() {
			return this.opts.useSecureWebSocket ?? S$1.useSecureWebSocket;
		}
		set useSecureWebSocket(t) {
			this.opts.useSecureWebSocket = t;
		}
		static get forceDisablePgSSL() {
			return S$1.opts.forceDisablePgSSL ?? S$1.defaults.forceDisablePgSSL;
		}
		static set forceDisablePgSSL(t) {
			S$1.opts.forceDisablePgSSL = t;
		}
		get forceDisablePgSSL() {
			return this.opts.forceDisablePgSSL ?? S$1.forceDisablePgSSL;
		}
		set forceDisablePgSSL(t) {
			this.opts.forceDisablePgSSL = t;
		}
		static get disableSNI() {
			return S$1.opts.disableSNI ?? S$1.defaults.disableSNI;
		}
		static set disableSNI(t) {
			S$1.opts.disableSNI = t;
		}
		get disableSNI() {
			return this.opts.disableSNI ?? S$1.disableSNI;
		}
		set disableSNI(t) {
			this.opts.disableSNI = t;
		}
		static get disableWarningInBrowsers() {
			return S$1.opts.disableWarningInBrowsers ?? S$1.defaults.disableWarningInBrowsers;
		}
		static set disableWarningInBrowsers(t) {
			S$1.opts.disableWarningInBrowsers = t;
		}
		get disableWarningInBrowsers() {
			return this.opts.disableWarningInBrowsers ?? S$1.disableWarningInBrowsers;
		}
		set disableWarningInBrowsers(t) {
			this.opts.disableWarningInBrowsers = t;
		}
		static get pipelineConnect() {
			return S$1.opts.pipelineConnect ?? S$1.defaults.pipelineConnect;
		}
		static set pipelineConnect(t) {
			S$1.opts.pipelineConnect = t;
		}
		get pipelineConnect() {
			return this.opts.pipelineConnect ?? S$1.pipelineConnect;
		}
		set pipelineConnect(t) {
			this.opts.pipelineConnect = t;
		}
		static get subtls() {
			return S$1.opts.subtls ?? S$1.defaults.subtls;
		}
		static set subtls(t) {
			S$1.opts.subtls = t;
		}
		get subtls() {
			return this.opts.subtls ?? S$1.subtls;
		}
		set subtls(t) {
			this.opts.subtls = t;
		}
		static get pipelineTLS() {
			return S$1.opts.pipelineTLS ?? S$1.defaults.pipelineTLS;
		}
		static set pipelineTLS(t) {
			S$1.opts.pipelineTLS = t;
		}
		get pipelineTLS() {
			return this.opts.pipelineTLS ?? S$1.pipelineTLS;
		}
		set pipelineTLS(t) {
			this.opts.pipelineTLS = t;
		}
		static get rootCerts() {
			return S$1.opts.rootCerts ?? S$1.defaults.rootCerts;
		}
		static set rootCerts(t) {
			S$1.opts.rootCerts = t;
		}
		get rootCerts() {
			return this.opts.rootCerts ?? S$1.rootCerts;
		}
		set rootCerts(t) {
...
var tr = T((Ai) => {
	...
	var vt = class vt$1 {
		...
		parse(e) {
			var t, n, i;
			for (this.consumeDimensions(); !this.isEof();) if (t = this.nextCharacter(), t.value === "{" && !i) this.dimension++, this.dimension > 1 && (n = new vt$1(this.source.substr(this.position - 1), this.transform), this.entries.push(n.parse(!0)), this.position += n.position - 2);
			else if (t.value === "}" && !i) {
...
var U, et, ts = G(() => {
	...
	U = class U$1 {
		...
		static _hex(e) {
			let t = U$1.hexChars, n = U$1.hexOut, i, s, o, u;
		...
		start() {
			return this._dataLength = 0, this._bufferLength = 0, this._state.set(U$1.stateIdentity), this;
		}
		appendStr(e) {
			...
			for (o = 0; o < e.length; o += 1) {
				...
				i >= 64 && (this._dataLength += 64, U$1._md5cycle(this._state, n), i -= 64, n[0] = n[16]);
			}
		...
		appendAsciiStr(e) {
			...
			for (;;) {
				...
				if (i < 64) break;
				this._dataLength += 64, U$1._md5cycle(this._state, n), i = 0;
			}
			return this._bufferLength = i, this;
		}
		appendByteArray(e) {
		...
		setState(e) {
			...
			if (n[t] = 128, n[t + 1] = n[t + 2] = n[t + 3] = 0, i.set(U$1.buffer32Identity.subarray(s), s), t > 55 && (U$1._md5cycle(this._state, i), i.set(U$1.buffer32Identity)), o <= 4294967295) i[14] = o;
			else {
			...
			return U$1._md5cycle(this._state, i), e ? this._state : U$1._hex(this._state);
		}
	};
...
var Ms = T((Ih, ks) => {
	"use strict";
	p();
	var pc = Je(), Fs = /^([A-Za-z]+)(?: (\d+))?(?: (\d+))?/, Lr = class Lr$1 {
		constructor(e, t) {
...
var qs = T((Rh, Os) => {
	"use strict";
	p();
	var { EventEmitter: dc } = ge(), Us = Ms(), Ds = rt(), kr = class kr$1 extends dc {
		constructor(e, t, n) {
...
var ln = T((_) => {
	...
	var Kr = class Kr$1 extends Error {
		constructor(e, t, n) {
...
var js = T((kt) => {
	...
	var Oc = d.allocUnsafe(0), mn = class mn$1 {
		constructor(e = 0) {
...
var Gs = T((Mt) => {
	...
	Mt.Parser = void 0;
	var k = ln(), qc = js(), wn = 1, Hs = wn + 4, $s = d.allocUnsafe(0), bn = class bn$1 {
		constructor(e) {
...
var En = T((Xh, Zs) => {
	"use strict";
	p();
	var Ks = (Fe(), O(wi)), Gc = ge().EventEmitter, { parse: Vc, serialize: Q } = vn(), Ys = Q.flush(), zc = Q.sync(), Kc = Q.end(), Sn = class Sn$1 extends Gc {
		constructor(e) {
...
var eo = T((np, Xs) => {
	...
	it(), O(nt);
	var Zc = rt(), An = ds(), Jc = Cs(), Xc = At(), el = Rt(), Js = qs(), tl = tt(), rl = En(), Cn = class Cn$1 extends Yc {
		constructor(e) {
...
var io = T((op, no) => {
	...
	}, "removeWhere"), Tn = class Tn$1 {
		constructor(e, t, n) {
			this.client = e, this.idleListener = t, this.timeoutId = n;
		}
	};
	a(Tn, "IdleItem");
	var _n = Tn, Pn = class Pn$1 {
		constructor(e) {
			this.callback = e;
		}
	};
...
var gt = class gt$1 {
	...
	toParameterizedQuery(e = {
		...
		for (let i = 0, s = t.length; i < s; i++) if (e.query += t[i], i < n.length) {
			...
			else if (o instanceof Ce) if (o.queryData instanceof gt$1) o.queryData.toParameterizedQuery(e);
			else {
...
var _t = class _t$1 extends Error {
	constructor(t) {
		super(t);
		...
		E(this, "routine");
		E(this, "sourceError");
		"captureStackTrace" in Error && typeof Error.captureStackTrace == "function" && Error.captureStackTrace(this, _t$1);
	}
};
a(_t, "NeonDbError");
...
p();
var wo = Se(ot());
var kn = class kn$1 extends wo.Client {
	constructor(t) {
		super(t);
		this.config = t;
	}
...
a(vl, "promisify");
var Un = class Un$1 extends go.Pool {
	constructor() {
		super(...arguments);
		E(this, "Client", ut);
