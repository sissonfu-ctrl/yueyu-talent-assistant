...
- **Endpoint**：`POST https://app-bt7xab93905d-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bt7xab93905d-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
